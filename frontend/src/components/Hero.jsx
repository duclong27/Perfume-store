...
//         <div className='flex  flex-col sm:flex-row border border-gray-400 mt-4' id="Hero"> 
//             {/* Hero Left Side */} 
...
//             </div> 
//             {/* Hero Right Side */}
//             <img className='w-full sm:w-1/2' src={assets.hero_pic3} alt="" />
//         </div> 
//   )
// }
