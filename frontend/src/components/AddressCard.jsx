...
// export default function AddressCard({ addr, onSetDefault, onDelete }) {
//   const {
//     addressId,
//     recipientName,
//     phoneNumber,
...
//     deletingId = null,
//     confirmDelete = true,  // ✅ nhận prop này
//   } = addr || {};
...
//           {/* Edit bằng Link + state */}
//           <Link
//             to={`/editAddressPage/${addressId}`} // <Route path="/editAddressPage/:addressId" element={<EditAddressPage />} />
...
//             onClick={(e) => {
//               e.stopPropagation();
//               console.log("edit addressId =", addressId);
//             }}
//           >
//             Edit
//           </Link>
